...
public class ConsoleMessage {
    ...
    public static final String BASEBALL_GAME_START_INPUT = "숫자를 입력해주세요 : ";
    public static final String BASEBALL_GAME_START_OUTPUT = "3개의 숫자를 모두 맞히셨습니다! 게임 끝";
    public static final String BASEBALL_GAME_RESTART_INPUT = "게임을 새로 시작하려면 1, 종료하려면 2를 입력하세요.";
